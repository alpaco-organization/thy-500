...
export function Splash() {
  return (
    <dialog className="group fixed left-0 top-0 z-100 flex h-full w-full items-center justify-center bg-background p-4 data-[state=hide]:animate-out fade-out duration-1000 fill-mode-forwards">
